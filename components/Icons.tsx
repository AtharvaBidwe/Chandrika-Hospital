...
export const HistoryIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/><path d="M3.3 14a9 9 0 1 1 .3 5"/></svg>
);
...
export const BoneIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M17 10c.7-.7 1.69-1 2.5-.5a2.5 2.5 0 1 1 0 5c-.81.5-1.8.2-2.5-.5Z"/><path d="M7 10c-.7-.7-1.69-1-2.5-.5a2.5 2.5 0 1 0 0 5c.81.5 1.8.2 2.5-.5Z"/><path d="M7 12h10"/><path d="M17 14c.7.7 1.69 1 2.5.5a2.5 2.5 0 1 0 0-5c-.81-.5-1.8-.2-2.5.5Z"/><path d="M7 14c-.7.7-1.69 1-2.5.5a2.5 2.5 0 1 1 0-5c.81-.5 1.8-.2 2.5.5Z"/></svg>
);
